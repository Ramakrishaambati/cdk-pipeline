...
internal class Ec2Stack : NestedStack
{
    ...
    public string KeyPairName { get; set; } = "prod-server-key-pair";
    ...
    public Ec2Stack(Construct scope, string id, IVpc vpc, INestedStackProps props = null) : base(scope, id, props)
    {
        ...
        var ec2Instance = new Instance_(this, "ProdServer", new InstanceProps
        {
    ...
    private SecurityGroup GetSecurityGroup(IVpc vpc)
    {
        ...
        var instanceSg = new SecurityGroup(this, "ProdServerSg", new SecurityGroupProps
        {
            Vpc = vpc,
            AllowAllOutbound = true,
            Description = "Prod Server SG"
        });
    ...
    {
        // Install dotnet, docker, etc. and register prod ssl, certificates for debugging
        var userData = UserData.ForLinux();
        userData.AddCommands(
            "#!/bin/bash",
            "apt-get update",
            "apt-get install -y dotnet-sdk-6.0",
            "dotnet prod-certs https --trust",
