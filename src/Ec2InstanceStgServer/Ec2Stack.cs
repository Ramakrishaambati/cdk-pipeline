...
internal class Ec2Stack : NestedStack
{
    ...
    public string KeyPairName { get; set; } = "stg-server-key-pair";
    ...
    public Ec2Stack(Construct scope, string id, IVpc vpc, INestedStackProps props = null) : base(scope, id, props)
    {
        ...
        //keypair = KeyPair.FromKeyPairName(this, "stg-server-key-pair", "<key pair name>");
        ...
        var ec2Instance = new Instance_(this, "StgServer", new InstanceProps
        {
    ...
    private SecurityGroup GetSecurityGroup(IVpc vpc)
    {
        ...
        var instanceSg = new SecurityGroup(this, "StgServerSg", new SecurityGroupProps
        {
            Vpc = vpc,
            AllowAllOutbound = true,
            Description = "Stg Server SG"
        });
    ...
    {
        // Install dotnet, docker, etc. and register stg ssl, certificates for debugging
        var userData = UserData.ForLinux();
        userData.AddCommands(
            "#!/bin/bash",
            "apt-get update",
            "apt-get install -y dotnet-sdk-6.0",
            "dotnet stg-certs https --trust",
